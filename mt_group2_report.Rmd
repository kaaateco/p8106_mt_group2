...
mars_tune <- train(log_antibody ~ ., data = train_data, method = "earth", 
...
The intial MARS model resulted in a complex model of 13 terms and multiple interactions selected. While it provided a reasonable fit, we sought to prune the model to avoid overfitting.
